...
var amChartsChartsDemo = function() {
    ...
    var demo2 = function() {
       var chart = AmCharts.makeChart("lion_amcharts_2", {
            ...
            "graphs": [{
                "alphaField": "alpha",
                "balloonText": "<span style='font-size:12px;'>: [[title]] در سال [[category]]<br><span style='font-size:20px;'>[[value]]</span> [[additional]]</span>",
                "fillAlphas": 1,
                "title": "درآمد",
                "type": "column",
                "valueField": "income",
    ...
    var demo3 = function() {
        var chart = AmCharts.makeChart("lion_amcharts_3", {
            ...
            "valueAxes": [{
                "unit": "%",
                "position": "left",
                "title": "نرخ رشد تولید ناخالص داخلی",
            }],
            "startDuration": 1,
            "graphs": [{
                "balloonText": "<b>[[value]]</b> : رشد تولید ناخالص داخلی در [[category]] (2004) ",
                "fillAlphas": 0.9,
                "lineAlpha": 0.2,
                "title": "2004",
                "type": "column",
                ...
                "balloonText": "<b>[[value]]</b> : رشد تولید ناخالص داخلی در [[category]] (2005)",
                "fillAlphas": 0.9,
                "lineAlpha": 0.2,
                "title": "2005",
                "type": "column",
    ...
    var demo5 = function() {
        var chart = AmCharts.makeChart("lion_amcharts_5", {
            ...
            "startDuration": 1,
            "graphs": [{
                "balloonText": "<span style='font-size:13px;'><b>[[value]]</b> : [[title]] در سال [[category]]</span>",
                "title": "درآمد",
                "type": "column",
                "fillAlphas": 0.8,
    ...
    var demo8 = function() {
        var chart = AmCharts.makeChart("lion_amcharts_8", {
            ...
            "graphs": [{
                "alphaField": "alpha",
                "balloonText": " در [[value]] مایل",
                "dashLengthField": "dashLength",
                "fillAlphas": 0.7,
                "legendPeriodValueText": "مجموع : [[value.sum]] مایل",
                 "legendValueText": " در [[value]] مایل ",
                "title": "مسافت",
                "type": "column",
                "valueField": "distance",
                "valueAxis": "distanceAxis"
            }, {
                "balloonText": "عرض جغرافیایی :[[value]]",
                "bullet": "round",
                "bulletBorderAlpha": 1,
                "useLineColorForBulletBorder": true,
                "bulletColor": "#FFFFFF",
    ...
    var demo9 = function() {
        var chart = AmCharts.makeChart("lion_amcharts_9", {
            ...
            "startDuration": 2,
            "graphs": [{
                 "balloonText": "میزان [[value]] لیتر نوشیدنی در سال",
                "bullet": "round",
                "lineThickness": 2,
                "valueField": "litres"
            }],
    ...
    var demo10 = function() {
         var chart = AmCharts.makeChart("lion_amcharts_10", {
            ...
            "startDuration": 1,
            "graphs": [{
               "balloonText": "[[category]]: [[value]] متر/ثانیه",
                "bullet": "round",
                "fillAlphas": 0.3,
                "valueField": "value"
            }],
    ...
    var demo12 = function() {
        ...
        var chartData = {
            "1995": [{
                ...
                {
                    "sector": "تجارت (عمده فروشی، خرده فروشی، موتوری)",
                    "size": 14.6
                },
                {
                ...
                {
                    "sector": "خدمات مالی، املاک و مستغلات و بازرگانی",
                    "size": 22.5
                }
            ],
            "1996": [{
