		  ...
		  nv.addGraph(function() {
			var chart = nv.models.cumulativeLineChart()
						  ...
						  .y(function(d) { return d[1]/100 }) //adjusting, 100% is 1.00, not 100 as it is in the data						  
		  				  .color(d3.scale.ordinal().range(["#fb9678", "#00c292", "#03a9f3", "#ab8ce4"]).range())
...
{ 
	...
	*/
	...
	d3.json('js/stackedAreaData.json', function(data) {
	  ...
	  nv.addGraph(function() {
		var chart = nv.models.stackedAreaChart()
					  ...
					  .clipEdge(true)
					  .color(d3.scale.ordinal().range(["#8d6658", "#fb9678", "#fec107", "#03a9f3", "#00c292", "#e4e7ea", "#ab8ce4"]).range());
