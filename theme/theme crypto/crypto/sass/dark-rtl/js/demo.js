...
//    }
  ...
  var $themeYellow =
        $('<li />', { style: 'padding: 5px;line-height: 25px;' })
          .append('<a href="javascript:void(0)" data-theme="theme-yellow" style="display: inline-block;vertical-align: middle;" class="clearfix active bg-gradient-yellow rounded w-40 h-80" title="تم زرد">'
            + '</a>')
  $skinsList.append($themeYellow)
	
  var $themePurple =
        $('<li />', { style: 'padding: 5px;line-height: 25px;' })
          .append('<a href="javascript:void(0)" data-theme="theme-purple" style="display: inline-block;vertical-align: middle;" class="clearfix bg-gradient-purple rounded w-40 h-80" title="تم بنفش">'
            + '</a>')
  $skinsList.append($themePurple)
	
  var $themeRed =
        $('<li />', { style: 'padding: 5px;line-height: 25px;' })
          .append('<a href="javascript:void(0)" data-theme="theme-red" style="display: inline-block;vertical-align: middle;" class="clearfix bg-gradient-red rounded w-40 h-80" title="تم قرمز">'
            + '</a>')
  $skinsList.append($themeRed)
		
  var $themeBlue =
        $('<li />', { style: 'padding: 5px;line-height: 25px;' })
          .append('<a href="javascript:void(0)" data-theme="theme-blue" style="display: inline-block;vertical-align: middle;" class="clearfix bg-gradient-blue rounded w-40 h-80" title="تم آبی">'
            + '</a>')
  $skinsList.append($themeBlue)
	
  var $themeGreen =
        $('<li />', { style: 'padding: 5px;line-height: 25px;' })
          .append('<a href="javascript:void(0)" data-theme="theme-green" style="display: inline-block;vertical-align: middle;" class="clearfix bg-gradient-green rounded w-40 h-80" title="تم سبز">'
            + '</a>')
  $skinsList.append($themeGreen)
	
  var $themeGrey =
        $('<li />', { style: 'padding: 5px;line-height: 25px;' })
          .append('<a href="javascript:void(0)" data-theme="theme-grey" style="display: inline-block;vertical-align: middle;" class="clearfix bg-theme-gradient-grey rounded w-40 h-80" title="تم خاکستری">'
            + '</a>')
  ...
  $demoSettings.append('<h4 class="control-sidebar-heading">رنگ های تم</h4>')
