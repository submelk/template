...
$(function () {
	...
	{
	"name": "مزرعه بادی<br><small class='text-muted'><i>هیچ بودجه ای قفل نشده<i></small>",
	...
	{
	"name": "پروژه مسکن<br><small class='text-muted'><i>هیچ بودجه ای قفل نشده<i></small>",
	...
	{
	"name": "مدیریت املاک<br><small class='text-muted'><i>هیچ بودجه ای قفل نشده<i></small>",
	"est": "<td><div class='progress progress-sm'><div class='progress-bar progress-bar-primary progress-bar-striped' role='progressbar' aria-valuenow='55' aria-valuemin='0' aria-valuemax='100' style='width: 55%'></div></div></td>",
