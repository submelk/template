...
$(function () {
	...
	var options = {
        ...
        xaxis: {
          categories: ['فرو', 'اردی', 'خرد', 'تیر', 'مرد', 'شهر', 'مهر', 'آبان', 'آذر', 'دی'],
		  labels: {
			show: true,        
          },
          axisBorder: {
            ...
            if(tooltip == "members") {
                tip.html(function (d, i) {
                    return "<div class='text-center bg-dark p-5'>" +
                            ...
                            "<span class='font-size-14'> کاربر </span>" +
            ...
            var tooltip = d3.tip()
                ...
                .html(function (d) {
                    return "<ul class='list-unstyled mb-1 bg-dark p-5'>" +
                        ...
                        "<li>" + "فروش : &nbsp;" + "<span class='float-right'>" + d.alpha + "</span>" + "</li>" +
                       "<li>" + "درآمد :  &nbsp; " + "<span class='float-right'>"  + (d.alpha * 0) + "تومان" + "</span>" + "</li>" + 
                    "</ul>";
                });
