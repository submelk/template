  ...
  "panels": [ {
     ...
     "categoryAxis": {
      ...
      "stockGraphs": [ {
        ...
        "valueField": "close",
        "lineColor": "#f9d423",
        "fillColors": ["#f9d423", "#ff4e50"],
        "negativeLineColor": "#f5d100",
        "negativeFillColors": ["#50cc7f", "#f5d100"],
        "fillAlphas": 1,
...
//---------------------------
var dom = document.getElementById("e_chart_6");
var myChart = echarts.init(dom);
var app = {};
option = null;
option = {
	color: ['#b224ef', '#7579ff', '#007adf', '#00ecbc' ],
	textStyle: {
		color: '#fff',
    fontFamily: 'yekan',
	},
