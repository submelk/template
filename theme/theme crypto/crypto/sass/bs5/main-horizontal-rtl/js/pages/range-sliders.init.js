...
$(function () {
	...
	$("#range_03").ionRangeSlider( {
        type: "double", grid: !0, min: 0, max: 1e3, from: 200, to: 800, postfix: " تومان "
    }
    ), 
	...
	$("#range_06").ionRangeSlider( {
        grid: !0, from: 3, values: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"]
    }
    ), 
	...
	$("#range_09").ionRangeSlider( {
        grid: !0, min: 18, max: 70, from: 30, prefix: " سن ", max_postfix: "+"
    }
    ), 
	$("#range_10").ionRangeSlider( {
        type: "double", min: 100, max: 200, from: 145, to: 155, prefix: " وزن : ", postfix: " کیلوگرم ", decorate_both: !0
    }
    ), 
