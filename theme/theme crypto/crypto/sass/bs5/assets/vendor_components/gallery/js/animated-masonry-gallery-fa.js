$(function () {
    ...
    function check_button(){
        ...
        if(button==1){
            ...
            $("#gallery-header-center-left-title").html('تمام گالری ها');
            }
        if(button==2){
            $("#filter-studio").addClass(button_class);
            $("#gallery-header-center-left-title").html('گالری استودیو');
            }
        if(button==3){
            $("#filter-landscape").addClass(button_class);
            $("#gallery-header-center-left-title").html('گالری مناظر');
            }	
    }
