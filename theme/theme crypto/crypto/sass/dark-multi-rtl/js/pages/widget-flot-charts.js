...
$(function () {
  ...
  $('#line-chart').bind('plothover', function (event, pos, item) {
    ...
    if (item) {
      var x = item.datapoint[0].toFixed(2),
       ...
       $('#line-chart-tooltip').html(item.series.label + ' از ' + x + ' = ' + y)
  ...
  var bar_data = {
    data : [['فرو', 19], ['ارد', 25], ['خرد', 27], ['تیر', 28], ['مرد', 15], ['شهر', 6], ['مهر', 17], ['آبان', 7], ['آذر', 14], ['دی', 24], ['بهمن', 16], ['اسفند', 2]],
  ...
  var donutData = [
    { label: 'فروردین - تیر', data: 85, color: '#ee1044' },
    { label: 'مرداد - آبان', data: 68, color: '#ff8f00' },
    { label: 'آذر-اسفند', data: 42, color: '#689f38' }
  ]
