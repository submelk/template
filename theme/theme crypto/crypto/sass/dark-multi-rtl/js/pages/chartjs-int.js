...
//----chart1
    ...
    blue_trans_gradient.addColorStop(0, '#f9d423');
    blue_trans_gradient.addColorStop(1, '#e14fad');
    // Chart Options
    var DASStats = {
        responsive: true,
    ...
    // Create Linear Gradient
    var blue_trans_gradient = dasChartjs.createLinearGradient(0, 0, 0, 100);
    blue_trans_gradient.addColorStop(0, '#b224ef');
    blue_trans_gradient.addColorStop(1, '#7579ff');
    // Chart Options
    var DASStats = {
        responsive: true,
        maintainAspectRatio: false,
    ...
    // Create Linear Gradient
    var blue_trans_gradient = dasChartjs.createLinearGradient(0, 0, 0, 100);
    blue_trans_gradient.addColorStop(0, '#007adf');
    blue_trans_gradient.addColorStop(1, '#00ecbc');
    // Chart Options
    var DASStats = {
        responsive: true,
        maintainAspectRatio: false,
    ...
    // Create Linear Gradient
    var blue_trans_gradient = dasChartjs.createLinearGradient(0, 0, 0, 100);
    blue_trans_gradient.addColorStop(0, '#22E1FF');
    blue_trans_gradient.addColorStop(1, '#1D8FE1');
    // Chart Options
    var DASStats = {
        responsive: true,
        maintainAspectRatio: false,
